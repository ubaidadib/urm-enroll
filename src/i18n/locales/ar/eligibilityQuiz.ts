export const eligibilityQuiz = {
  ...
  intro: {
    ...
    quizFormat: "تنسيق الاختبار",
    time: "الوقت",
    scoreModel: "نموذج النقاط",
    missionCheckpoints: "محطات المهمة",
    quickTaps: "١٨ اختيارات سريعة",
    realPointsLogic: "منطق نقاط حقيقي",
  },
  progress: {
    step: "خطوة",
    of: "من",
  ...
  result: {
    ...
    missionStatusLabel: "حالة المهمة",
    missionPassed: "المهمة ناجحة",
    missionInProgress: "المهمة قيد التقدم",
    missionPassedNote: "تجاوزت الحد الأدنى لنقاط بطاقة الفرص.",
    missionInProgressNote: "لا يزال أمامك مسار. استخدم خطة العمل أدناه لتحسين ملفك.",
    missionControl: "مركز التحكم بالمهمة",
    startMission: "ابدأ مهمتك",
    continueCheckpoint: "تابع إلى المحطة التالية",
    dismissMilestone: "إغلاق الإنجاز",
