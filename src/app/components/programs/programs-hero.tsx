...
export function ProgramsHero({
  ...
  return (
    <section className="relative page-hero-offset page-hero-pb bg-bg-primary px-4 sm:px-6 lg:px-[var(--content-gutter)]">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-text-muted">{t<string>("programs.listing.hero.stats.countriesAvailable")}</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-text-primary">{t<string>("programs.listing.hero.stats.smartMatch")}</p>
                <p className="text-xs text-text-muted">{t<string>("programs.listing.hero.stats.aiMatching")}</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-text-primary">{t<string>("programs.listing.hero.stats.programs")}</p>
                <p className="text-xs text-text-muted">{t<string>("programs.listing.hero.stats.fromTopInstitutions")}</p>
              </div>
            </div>
          </m.div>
        </div>
            ...
            <div className="rounded-3xl border border-border bg-white/50 backdrop-blur-xl p-6 dark:bg-brand-softnav-900/40 dark:border-border/50">
              ...
              <div className="mt-6 space-y-4">
                <div className="flex items-center justify-between rounded-2xl bg-brand-gold-100/50 dark:bg-brand-gold-900/20 px-4 py-3">
                  <span className="text-sm font-semibold text-text-primary">{t<string>("programs.listing.hero.insights.premiumScholarships")}</span>
                ...
                <div className="flex items-center justify-between rounded-2xl bg-brand-steel-100/50 dark:bg-brand-steel-900/20 px-4 py-3">
                  <span className="text-sm font-semibold text-text-primary">{t<string>("programs.listing.hero.insights.visaFriendly")}</span>
                ...
                <div className="flex items-center justify-between rounded-2xl bg-brand-softnav-100/50 dark:bg-brand-softnav-900/30 px-4 py-3">
                  <span className="text-sm font-semibold text-text-primary">{t<string>("programs.listing.hero.insights.highEmployability")}</span>
