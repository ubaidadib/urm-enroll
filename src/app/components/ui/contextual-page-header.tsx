...
export function ContextualPageHeader({
  ...
  return (
    <section
      className="relative px-[var(--content-gutter)] page-hero-offset page-hero-pb-compact overflow-hidden premium-hero-surface transition-colors duration-500"
    >
      {/* Ambient atmosphere */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute -top-24 -right-20 w-[28rem] h-[28rem] rounded-full bg-accent-tech/10 blur-[120px]" />
        <div className="absolute -bottom-20 -left-16 w-[24rem] h-[24rem] rounded-full bg-accent-primary/10 blur-[120px]" />
          ...
          <div className={hasStats ? "page-hero-main" : isListing ? "w-full" : "w-full max-w-4xl"}>
            ...
            {searchSlot ? (
              <m.div
                ...
                className={isListing ? "mt-4 lg:mt-5 rounded-2xl premium-filter-panel p-4" : "mt-5 lg:mt-6 rounded-2xl premium-filter-panel p-4"}
              >
                {searchSlot}
              </m.div>
            ) : null}
              ...
              {stats.slice(0, 4).map((stat) => {
                ...
                return (
                  <div
                    ...
                    className="rounded-2xl p-4 flex items-center gap-3 premium-stat-card transition-all"
                  >
