        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {TESTIMONIALS.map((item, index) => (
            <m.article
              ...
              className="rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-bg-surface p-6 shadow-[0_2px_8px_rgba(8,21,48,0.06)] hover:shadow-[0_8px_32px_rgba(8,21,48,0.12)] transition-shadow"
            >
