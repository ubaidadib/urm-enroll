          ...
          <aside className="lg:w-60 flex-shrink-0">
            <div className="sticky top-24 space-y-1">
              ...
              {TOC_IDS.map((id) => (
                ...
                >
                  <span className="w-1.5 h-1.5 rounded-full bg-accent-success/40 flex-shrink-0" />
                  {tocLabels[id]}
                </a>
              ))}
...
with open("/Users/ubaidadib/Desktop/urm-enroll/src/app/pages/articles/student-visa-germany-guide.tsx", "w", encoding="utf-8") as f:
    f.write(content)
